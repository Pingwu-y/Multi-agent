...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='rmappo', choices=["rmappo", "matd3", "maddpg", "imatd3", "imaddpg"])
    ...
    parser.add_argument("--save_data", action='store_true', default=True, help='use to save data in rendering')
